...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            super(view);
//            userImage = (CustomImageView) view.findViewById(R.id.nearly_user_image);
//            title = (TextView) view.findViewById(R.id.nearly_title_textview);
//            type = (TextView) view.findViewById(R.id.nearly_type_textview);
//            time = (TextView) view.findViewById(R.id.nearly_time_textview);
//            distance = (TextView) view.findViewById(R.id.nearly_distance_textview);
